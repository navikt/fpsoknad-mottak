...
@Component
public class V2EngangsstønadXMLVedtakMapper implements XMLVedtakMapper {

    private static final Logger LOG = LoggerFactory.getLogger(V2EngangsstønadXMLVedtakMapper.class);

    private static final VedtakV2ESJAXBUtil JAXB = new VedtakV2ESJAXBUtil(false, false);

    @Override
    public MapperEgenskaper mapperEgenskaper() {
        return new MapperEgenskaper(V2, INITIELL_ENGANGSSTØNAD);
    }
