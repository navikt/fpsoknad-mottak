...
import static no.nav.foreldrepenger.mottak.innsending.pdf.PdfOutlineItems.FORELDREPENGER_OUTLINE;
...
public class ForeldrepengerPDFGenerator implements PDFGenerator {
    ...
    private byte[] generate(Søknad søknad, Person søker) {
        ...
        try (FontAwarePDDocument doc = new FontAwarePDDocument();
            ...
            fpRenderer.addOutlineItem(doc, page, FORELDREPENGER_OUTLINE.getTitle());
