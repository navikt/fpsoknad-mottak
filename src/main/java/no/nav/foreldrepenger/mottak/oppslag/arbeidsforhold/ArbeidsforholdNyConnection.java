...
@Component
public class ArbeidsforholdNyConnection extends AbstractWebClientConnection {

    private static final Logger LOG = LoggerFactory.getLogger(ArbeidsforholdNyConnection.class);
    private final ArbeidsforholdConfig cfg;
    private final OrganisasjonConnection organisasjon;

    public ArbeidsforholdNyConnection(@Qualifier(ARBEIDSFORHOLD) WebClient client, ArbeidsforholdConfig cfg,
