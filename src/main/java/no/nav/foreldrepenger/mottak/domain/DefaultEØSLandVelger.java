...
public class DefaultEØSLandVelger implements EØSvelger {

    private static final List<CountryCode> COUNTRIES = Arrays.asList(AT, BE, BG, HR, CY, CZ, DE, EE, IE, IT, LV, LT, LU,
            MT, NL, PL, PT, RO, SK, SI, ES, SE, UK, NO, IS, LI, NO);

    @Override
    public boolean isEøsLand(CountryCode cc) {
