    ...
    private static Frilans frilans(Versjon v, String... vedleggRefs) {
        return new Frilans(åpenPeriode(v, true), true, true,
                newArrayList(
                        ...
                        new FrilansOppdrag("den andre bror min", åpenPeriode(v, true)),
                        new FrilansOppdrag("den tredje bror min", åpenPeriode(v, true)),
                        new FrilansOppdrag("den fjerde ebror min", åpenPeriode(v, true)),
