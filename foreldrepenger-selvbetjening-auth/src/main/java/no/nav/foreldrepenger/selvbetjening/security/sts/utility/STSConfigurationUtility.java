package no.nav.foreldrepenger.selvbetjening.security.sts.utility;
...
import no.nav.foreldrepenger.selvbetjening.security.sts.client.ModigClaimsCallbackHandler;
import no.nav.foreldrepenger.selvbetjening.security.sts.client.NAVSTSClient;
...
public class STSConfigurationUtility {
    ...
    public static void configureStsForExternalSSO(Client client) {
        ...
        String username = requireProperty(SYSTEMUSER_USERNAME);
        String password = requireProperty(SYSTEMUSER_PASSWORD);
    ...
    public static void configureStsForOnBehalfOfWithUNT(Client client) {
        ...
        STSClient stsClient = createBasicSTSClient(client.getBus(), location, username, password);
        stsClient.setOnBehalfOf(new ModigClaimsCallbackHandler());
